        ...
        return <Fragment>
            ...
            <div class="card">
                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    {/* Metadata */}
                    {/* Title */}
                    <h1 className="title is-size-3 is-size-4-mobile mb-2 has-text-weight-normal">
                        {index ?
                    ...
                    {page.layout !== 'page' ? <div class="article-meta is-size-7 is-uppercase level is-mobile mb-4">
